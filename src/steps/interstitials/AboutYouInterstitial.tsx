...
export default function AboutYouInterstitial() {
  ...
  const getContent = () => {
    if (gender === "woman" && ageRange && !["u17", "18-24"].includes(ageRange)) {
      return {
        ...
        stats: [
          "73% of Canadian women report excellent or very good health",
          "Regular preventive care reduces health risks by up to 40%",
          "Women who engage with healthcare early have better long-term outcomes"
        ],
      ...
      return {
        ...
        stats: [
          "Only 61% of Canadian men report excellent mental health vs 53% of women",
          "Men are 3x less likely to seek mental health support",
          "Early intervention improves mental health outcomes by 60%"
        ],
    ...
    return {
      ...
      stats: [
        "Canadians with regular healthcare access report 25% better health outcomes",
        "Preventive care reduces emergency visits by 35%",
        "Personalized healthcare improves satisfaction by 50%"
      ],
  ...
  return (
    <div className="max-w-[640px]">
      ...
      <StepNav onBack={prev} onNext={next} nextLabel="Let's continue" />
    </div>
  )
}
